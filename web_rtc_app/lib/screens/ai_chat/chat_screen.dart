...
import 'package:web_rtc_app/screens/ai_chat/chat_widget.dart';
import 'package:web_rtc_app/screens/ai_chat/loading_widget.dart';
import 'package:web_rtc_app/screens/ai_chat/model_selection_screen.dart';

import 'models/model.dart';
import 'services/auth_token_service.dart';

class AIChatScreen extends StatefulWidget {
  const AIChatScreen({super.key, this.model = Model.gemma3_1B, this.selectedBackend});
...
class AIChatScreenState extends State<AIChatScreen> {
  ...
  Future<void> _initializeModel() async {
    ...
    try {
      ...
      debugPrint('[ChatScreen] Step 2: Installing model url ${widget.model.url}...');
