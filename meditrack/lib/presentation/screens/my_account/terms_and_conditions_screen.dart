...
class _TermsAndConditionsScreenState
    extends BaseConsumerState<TermsAndConditionsScreen, MyAccountViewModel> {
  ...
  void initState() {
    ...
    controller = WebViewController()
      ...
      ..loadRequest(Uri.parse(AppConstants.webPageTermsAndConditionsUrl));
  }

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: LanguageKeys.termsAndConditions.tr()),
