...
class _AboutUsScreenState
    extends BaseConsumerState<AboutUsScreen, MyAccountViewModel> {
  ...
  void initState() {
    ...
    controller = WebViewController()
      ...
      ..loadRequest(Uri.parse(AppConstants.webPageAboutUsUrl));
  }

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: LanguageKeys.aboutUs.tr()),
